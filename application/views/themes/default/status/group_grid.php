			...
			<td style="text-align: left; width: 133px">
				<?php
					...
					if (isset($pnp_path) && pnp::has_graph($host->host_name))
						echo '<a href="'.pnp::controller_path($host->host_name).'" style="border: 0px">'.html::image($icon_path.'pnp.png', array('alt' => $label_pnp, 'title' => $label_pnp, 'class' => 'pnp_graph_icon')).'</a>&nbsp;';
